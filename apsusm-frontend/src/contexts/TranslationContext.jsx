...
const translations = {
  en: {
    ...
    feature_card_desc: 'Receive a professionally designed digital card with your photo and unique member ID.',
    feature_verify_title: 'Secure Verification',
    feature_verify_desc: 'Every membership can be verified securely online using the issued member ID.',
  ...
  pt: {
    ...
    feature_card_desc: 'Receba um cartão digital profissionalmente projetado com sua foto e ID de membro exclusivo.',
    feature_verify_title: 'Verificação Segura',
    feature_verify_desc: 'Cada filiação pode ser verificada online de forma segura usando o ID de membro emitido.',
